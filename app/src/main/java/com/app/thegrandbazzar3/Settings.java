...
public class Settings {
    public static final String HOST = "thegrandbazzar.com";//endparsehost
    public static final String HOME_URL = "http://thegrandbazzar.com";//endparsehomeurl
    ...
    public static final String PLAY_STORE_LINK_ID = "com.app.thegrandbazzar3"; // package name
